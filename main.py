...
def ask_question(chat_id, question_index):
    if question_index < len(questions):
        ...
        bot.send_message(chat_id, "Поздравляю, все загадки разгаданы!!! И значит в НОВОМ 2️⃣0️⃣2️⃣5️⃣ ГОДУ исполнится Ваше самое заветное желание! 🏆❤️✨🚀💰 С Новым годом!!!☃️🍾🎄")
