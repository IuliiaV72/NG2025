...
# Токен бота
TOKEN = os.getenv('TELEGRAM_TOKEN', '7565067409:AAHMpz1GdKTf5zuEVa7xOW1a2kmEkfIUNig')
if not TOKEN:
...
if __name__ == "__main__":
    try:
        ...
        # Устанавливаем вебхук с правильным URL на Vercel
        webhook_url = f"https://<your_project_name>.vercel.app/{TOKEN}"
